...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function fit_models_face_2_v2;

%online face study. Works with do_fits_get_performance.m to fit theoretical
%models to behavioural data.
...
Generate_params.comment = 'out_imageTask_face_2_COCSBMP2_';     %The filename will already fill in basic parameters so only use special info for this.

disp('Getting subject data ...');
num_subs_found = 0;

%returns (preserving legacy variable names):
...
end;    %sub loop to transfer subject data from get_sub_data output to Generate_params
...
temp_r = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\face_study_2_online\data\all_attractiveness_ratings_noheader_online.xlsx');
...
[temp_d dummy dummy] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\face_study_2_online\data\all_sequences_online.xlsx');
...
[dummy dummy temp_f] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\face_study_2_online\data\all_domains_online_sequence_fnames.xlsx');
...
[dummy1 dummy2 key_ratings] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\face_study_2_online\data\domains_key_ratings_fnames.xlsx');
