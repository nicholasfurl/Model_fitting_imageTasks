...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = fit_models_holiday_2_v2;
...
Generate_params.comment = 'out_imageTask_holiday_2_COCSBMP2_';     %The filename will already fill in basic parameters so only use special info for this.
...
temp_r = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\holiday_study_2_openday\data\all_attractiveness_ratings_noheader_openday.xlsx');
...
[temp_d dummy dummy] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\holiday_study_2_openday\data\all_sequences_openday.xlsx');
...
[dummy dummy temp_f] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\holiday_study_2_openday\data\all_domains_openday_sequence_fnames.xlsx');
seq_fnames = temp_f(find(cell2mat(temp_f(:,1)) == 1),:);
%filename index key (cols: holiday, food, male, female) 90 filenames key to ratings
[dummy1 dummy2 key_ratings] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\holiday_study_2_openday\data\domains_key_ratings_fnames.xlsx');
