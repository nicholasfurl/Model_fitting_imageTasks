...
preparestring('Press key "2" to choose the most trustworthy face.',1,0, line_start-line_increment);
preparestring('If you have not chosen by the last face, we assume you find it the most trustworthy.',1,0, line_start-line_increment*2);
...
for trial=1:num_seqs;
    ...
    preparestring(['HERE IS YOUR CHOICE! How rewarding do you find this choice?'],1,0,line_start+100);
