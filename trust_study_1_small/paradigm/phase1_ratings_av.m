...
preparestring('Please rate how trustworthy you find each face on a scale from 1 to 9',1,0, line_start);
...
%     rating = data{order(i),2};
    rating = 'rate from 1 (Very untrustworthy) to 9 (Very trustworthy)?';
