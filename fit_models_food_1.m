...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = new_fit_code_foods_online_subs(all_draws_set,log_or_not);

%_betafix uses beta properly when simulating model results for the Bayesian models
...
%v3_sweep isn't an improvement on v2 buit starts a new branch. V2 (and its
...
comment = sprintf('foodsonlineSubs_io_Log%d',log_or_not);     %The filename will already fill in basic parameters so only use special info for this.
...
filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_foodsonlineSubsLog0_20213107.mat';
...
if make_est_model_data == 1;
    ...
    %Now run the estimations for the rest of the models
