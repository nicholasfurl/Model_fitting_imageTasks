...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = fit_models_face_3_v2


%faces open day model fits. Needs imageTask_run_models.m to work. Needs
...
Generate_params.comment = 'out_imageTask_face_3_COCSBMP2_';     %The filename will already fill in basic parameters so only use special info for this.
...
temp_r = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\face_study_3_openday\data\all_attractiveness_ratings_noheader_openday.xlsx');
...
[temp_d dummy dummy] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\face_study_3_openday\data\all_sequences_openday.xlsx');
...
[dummy dummy temp_f] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\face_study_3_openday\data\all_domains_openday_sequence_fnames.xlsx');
...
[dummy1 dummy2 key_ratings] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\face_study_3_openday\data\domains_key_ratings_fnames.xlsx');
