...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = new_fit_code_match_betafix;
...
comment = 'matchLog';    %The filename will already fill in basic parameters so only use special info for this.
outpath = 'C:\matlab_files\fiance\parameter_recovery\outputs';
%Unfortunately still needs to be typed in manually
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll0_matchLog_20210707.mat';
filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_matchNoLog_20210407.mat';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_sTrustNoLog_20211007.mat';
...
data_folder = 'C:\matlab_files\fiance\matchmaker\match_maker_data';
...
mean_position_choices = squeeze(nanmean(position_choices,1));
ci_position_choices = squeeze(1.96*(nanstd(position_choices,1,1)/sqrt(size(position_choices,1))));
...
for identifier = 1:numel(Generate_params.do_models_identifiers);
    ...
    text( 0, Generate_params.seq_length + .5 ...
