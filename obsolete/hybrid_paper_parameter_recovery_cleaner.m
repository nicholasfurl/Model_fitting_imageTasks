...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = param_recover_v3_sweep_cleaner;

%*_cleaner.m is just organised a bit better, with some superfluous code
%deleted, to make slightly more readable to public.
...
%                 field_counter = field_counter + 1;
                ...
                %one of the models, CO has one insane outlier. Remove observation (only use for publication figure visibility!!!!!)
                if strcmp(Generate_params.model(model_field).name,'CO');
                    temp_param_data(4) = NaN;
                end;
