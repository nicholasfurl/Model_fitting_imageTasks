...
comment = sprintf('imageTask_face_1');    %The filename will already fill in basic parameters so only use special info for this.
...
writematrix(out,'C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\outputs\models_imageTask_face_1.csv');
