...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = new_fit_code_hols_openday_subs(all_draws_set,log_or_not);
...
comment = sprintf('holsOpendaySubsLog%d',log_or_not);     %The filename will already fill in basic parameters so only use special info for this.
outpath = 'C:\matlab_files\fiance\parameter_recovery\outputs';
%Unfortunately still needs to be typed in manually
filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_holsOpendaySubsLog0_20210408.mat';
