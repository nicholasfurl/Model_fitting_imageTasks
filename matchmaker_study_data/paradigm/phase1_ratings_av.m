...
preparestring('Please rate how attractive your client would find each face on a scale from 1 to 9',1,0, line_start);
...
%     rating = data{order(i),2};
    rating = 'rate from 1 (Very unattractive to client) to 9 (Highly attractive to client)?';
