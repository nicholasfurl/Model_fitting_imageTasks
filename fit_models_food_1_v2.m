...
Generate_params.comment = 'out_imageTask_food_1_COCSBMP2_';     %The filename will already fill in basic parameters so only use special info for this.
...
temp_r = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\food_study_1_online\data\all_attractiveness_ratings_noheader_online.xlsx');
...
[temp_d dummy dummy] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\food_study_1_online\data\all_sequences_online.xlsx');
...
[dummy dummy temp_f] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\food_study_1_online\data\all_domains_online_sequence_fnames.xlsx');
seq_fnames = temp_f(find(cell2mat(temp_f(:,1)) == 2),:);
%filename index key (cols: holiday, food, male, female) 90 filenames key to ratings
[dummy1 dummy2 key_ratings] = xlsread('C:\matlab_files\fiance\parameter_recovery\beta_fixed_code\Model_fitting_imageTasks\food_study_1_online\data\domains_key_ratings_fnames.xlsx');
