...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = new_fit_code_big_trust_v2;
...
comment = 'bigtrustLog';    %The filename will already fill in basic parameters so only use special info for this.
outpath = 'C:\matlab_files\fiance\parameter_recovery\outputs';
%Unfortunately still needs to be typed in manually
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll0_bigtrustLog_20211607.mat';
%These correspond to identifiers (not configured implementations like in v2) in the v3_sweep version
filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_bigtrustNoLog_20211007.mat';
