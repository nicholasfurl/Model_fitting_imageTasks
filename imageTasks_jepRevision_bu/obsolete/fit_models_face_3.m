...
log_or_not = 1; %I'm changing things so all simulated data is logged at point of simulation (==1) or not
...
comment = sprintf('facesOpendaySubsLog%d',log_or_not);     %The filename will already fill in basic parameters so only use special info for this.
outpath = 'C:\matlab_files\fiance\parameter_recovery\outputs';
%Unfortunately still needs to be typed in manually
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_HybridPriorSubsLog0vals1_20211108';
% filename_for_plots = 'C:\matlab_files\fiance\parameter_recovery\outputs\out_new_ll1_HybridPrior2SubsLog0vals0_20211208';
